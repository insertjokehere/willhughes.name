...
RUN wget -q https://github.com/spf13/hugo/releases/download/v${HUGO_VER}/hugo_${HUGO_VER}_Linux-64bit.tar.gz && tar -xf hugo_${HUGO_VER}_Linux-64bit.tar.gz && mv hugo_${HUGO_VER}_linux_amd64/hugo_${HUGO_VER}_linux_amd64 /usr/local/bin/hugo && rm hugo_${HUGO_VER}_Linux-64bit.tar.gz
